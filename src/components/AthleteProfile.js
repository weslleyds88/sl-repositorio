          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-6">
              {formData.avatar_url ? (
                ...
                <div className="w-24 h-24 bg-primary-100 rounded-full flex items-center justify-center border-4 border-primary-300">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-gray-900">{formData.gender || 'Não informado'}</span>
                  </div>
                </div>
              </div>
